...
### What they did:  
The researchers used standardized metrics to study fecundity, foraging behavior, seed abundance and distribution, and morphological characteristics of two finch species, *G. fortis* (ground finch) and *G. scandens* (cactus finch).  The physical traits in question were reduced from an initial list of six measures to three synthetic traits: body size, beak size, and beak shape. Two major observations were summarized the study:  
  (A). Identifying the patterns of microevolutionary events through shifts in any of those three synthetic traits, and associating the ecolgical parameters that may have led to such changes.  
  (B). Understanding what role hybridization may play in the observed shifts in means and variance of a trait in a population over time.
